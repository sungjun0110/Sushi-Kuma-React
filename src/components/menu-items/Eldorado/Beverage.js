...
const Beverage = () => {
  return(
    <div className='item-div'>
      ...
      <div className="items">
        <Item itemName="Beer Bottle 12oz" description="Sapporo, Asahi, Kirin, Bud Light, Corona, Blue moon" price="S 3.95 | L 6.50" />
        <Item itemName="Draft Beer" description="Sapporo" price="12oz: 3.50 | 22oz: 6.50 | Pitcher: 15.95" />
