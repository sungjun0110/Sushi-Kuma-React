  ...
  return(
    <div className="item-div">
        {CreateItems(
          ...
          {
            "Sushi-5": ["5 pcs chef's choice nigiri sushi & california roll", "19.50"],
            "Sushi-7" : ["7 pcs chef’s choice nigiri sushi & california roll", "23.50"], 
            "Sushi-9" : ["9 pcs chef’s choice nigiri sushi & california roll", "29.50"], 
            ...
            "Sashimi Deluxe" : ["25 pcs chef’s choice of sliced raw fish & served with steamed rice", "49.95"], 
        }, props)}
    </div>
  );
}
