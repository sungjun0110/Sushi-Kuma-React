...
const Bento = () => {
    ...
    <div className='item-div'>
      ...
      <div className="bento-description">Dinner: 19.95<br /><span style={{fontSize: '18px'}}>* Served with soup, salad & rice *<br />* Duplicate choices charge extra $ 1*<br />* No substitution on bento box *</span></div>
