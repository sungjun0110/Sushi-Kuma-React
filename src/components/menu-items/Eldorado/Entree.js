  ...
  return(
    <div className='item-div'>
        {CreateItems(
          "Noodle Soup", 
          {
          "Veggie Udon" : ["thick noodle soup with vegetable", "L 12.95 | D 15.95"], 
          "Beef Udon" : ["thick noodle soup with beef & vegetable", "L 14.95 | D 17.95"], 
          "Nabe Udon" : ["thick noodle soup with shrimp tempura, chicken, vegetable", "L 14.95 | D 17.95"], 
          "Tempura Udon" : ["thick noodle soup with vegetable & mixed tempura on the side", "L 14.95 | D 17.95"], 
          "Seafood Udon" : ["thick noodle soup with assorted seafood & vegetable", "L 14.95 | D 17.95"], 
        }, props)}
