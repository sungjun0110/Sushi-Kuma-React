  ...
  return (
    <div className="item-div">
      {CreateItems(
        "Street Foods", 
        {
        "Bulgogi Tacos" : ["marinated Korean style beef, white/red cabbage, cilantro (3pcs)", "14.95"], 
        "Ahi Poke Tacos" : ["seared ahi tuna, avocado, cilantro, white/red cabbage, sesame oil, special sauce (3pcs)", "14.95"], 
        "Zig Zag Tacos" : ["crispy soft shell crab, avocado, white/red cabbage, cilantro, zig zag sauce (3pcs)", "13.95"], 
        "Vegetable Bibimbap" : ["rice, seasonal vegetable, vinaigrette, sesame oil, Korean hot sauce/with miso soup", "11.95"], 
        "Bulgogi Bibimbap" : ["rice, marinated beef, seasonal vegetable, sesame oil, Korean hot sauce / with miso soup", "14.95"], 
        ...
        "Tempura Donburi" : ["shrimp - 3pcs and assorted seasonal vegetables - 7pcs", "15.95"], 
