...
const LunchBento = () => {
    return (
        <div className="item-div">
            ...
            <div className="bento-description">Lunch: 13.50<br /><span style={{fontSize: '20px'}}>* Served with soup, salad & rice *<br />* Duplicate choices charge extra $ 1*<br />* No substitution on bento box *</span></div>
