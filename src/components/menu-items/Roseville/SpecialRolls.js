...
const SpecialRolls = () => {
  return(
    ...
    <div className="item-div">
      ...
      <div className="items">
        <Item itemName="Fair Way" description="Deep-fried shrimp | avocado, masago | special sauce" price="14.99" />
        <Item itemName="Golden Gate" description="Deep-fried shrimp | crab meat, masago | special sauce" price="15.99" />
        <Item itemName="Hwy 65" description="Crabmeat, avocado | cooked shrimp, masago | special sauce" price="16.99" />
        <Item itemName="Chicken Teriyaki Roll" description="avocado, cream cheese, grilled chicken  | unagi sauce | 5pcs" price="14.99" />
        ...
        <Item itemName="Tempura Crunchy" description="Deep-fried shrimp, avocado, crab meat, crunchy |unagi sauce | 5pcs" price="14.99" />
      ...
      <div className="items">
        <Item itemName="Benjaminn Roll" description="Spicy tuna, spicy crab meat, cilantro | unagi, masago | special sauce" price="17.99" />
        ...
        <Item itemName="Rocklin" description="Deep-fried soft shell crab, cream cheese| unagi | masago" price="18.50" />
        ...
        <Item itemName="Kamikaze" description="Spicy crab, jalapeno, cream cheese | cooked shrimp, eel, salmon, masago | special sauce" price="18.50" />
      </div>

      <div className="item-title">Raw</div>
      <div className="items">
        <Item itemName="49er" description="Deep-fried shrimp, cream cheese, cucumber | salmon, lemon, masago | special sauce" price="16.50" />
        <Item itemName="911" description="Spicy tuna, cucumber | tuna, masago | spicy & special sauce" price="16.50" />
        <Item itemName="Arigato" description="Deep-fried shrimp | salmon, tuna, masago | special sauce" price="15.99" />
        ...
        <Item itemName="Folsom Lake" description="Deep-fried shrimp, spicy tuna | salmon, masago | special sauce" price="17.99" />
        <Item itemName="Happy" description="Deep-fried shrimp | tuna, yellowtail, masago | special sauce" price="16.99" />
        <Item itemName="Kiss Me" description="Crab meat, avocado | salmon, masago | special sauce" price="16.50" />
        <Item itemName="Kuma" description="Deep-fried shrimp | avocado, sweet shrimp & 5 kinds of raw fish masago | special sauce" price="19.50" />
        <Item itemName="Las Vegas" description="Deep-fried asparagus, crabmeat, cream cheese | tuna, salmon, masago, special sauce" price="17.99" />
        <Item itemName="Mafia" description="Deep-fried shrimp, crabmeat, cream cheese | scallop, salmon, masago | special sauce" price="17.99" />
        ...
        <Item itemName="Playboy" description="Spicy tuna, spicy crab meat, cilantro | salmon, lemon, masago" price="18.50" />
        <Item itemName="Thunder Valley" description="Deep-fried shrimp, crab meat | scallop, masago | special sauce" price="17.99" />
      ...
      <div className="items">
        ...
        <Item itemName="Roseville" description="Deep-fried soft shell crab, crab meat | salmon, seared tuna, masago | special sauce" price="18.99" />
        ...
        <Item itemName="Lincoln" description="Deep-fried asparagus, spicy crab | seared white tuna, deep-fried Onion | unagi sauce" price="17.99" />
        <Item itemName="Diablo" description="Deep-fried shirimp, spicy tuna | 5 kinds of seared fish, masago | chili pepper, unagi sauce" price="18.99" />
        <Item itemName="Yosemite" description="Deep-fried shrimp, spicy crab | seared tuna, deep-fried carrot | unagi sauce" price="16.50" />
        <Item itemName="TNT" description="Deep-fried asparagus, spicy crab meat | spicy tuna, jalapeno, crunch, masago | unagi sauce" price="18.50" />
        <Item itemName="Zig Zag Roll" description="Deep-fried soft shell crab, avocado, zig zag sauce | Soy Wrap" price="17.99" />
      </div>
