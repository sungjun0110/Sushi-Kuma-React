  ...
  return(
    <div className="item-div">
      {CreateItems(
        ...
        "Green Salad" : ["served with house dressing sauce", "5.95"], 
      ...
      {CreateItems(
        ...
        "7 Pcs Sashimi" : ["choice of one - salmon, tuna, yellowtail - 7 pcs", "15.50"], 
        "Assorted Sashimi" : ["chef's choice of today's raw fish - 12 pcs", "19.95"], 
        "Garlic Sashimi" : ["7pcs of salmon with fried garlic special sauce", "15.95"], 
        "Hamachi Carpaccio" : ["Sliced Hamachi jalapeno with chili pepper ponzu olive oil", "15.95"], 
        }, 
        props
      )}
    </div>
