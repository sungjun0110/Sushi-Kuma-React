    ...
    return (
        <div className="item-div">
            {CreateItems(
                ...
                {
                    "Veggie Udon": [
                        "a thick noodle soup with vegetable",
                        "L 13.95 | D 16.95"
                    ],
                    "Beef Udon": [
                        "a thick noodle soup with beef & vegetable",
                        "L 15.95 | D 18.95"
                    ],
                    "Nabe Udon": [
                        "a thick noodle soup with shrimp tempura, chicken, vegetable",
                        "L 15.95 | D 18.95"
                    ],
                    "Tempura Udon": [
                        "a thick noodle soup with vegetable & mixed tempura on the side",
                        "L 15.95 | D 18.95"
                    ],
                    "Seafood Udon": [
                        "a thick noodle soup with assorted seafood & vegetable",
                        "L 15.95 | D 18.95"
                    ]
                },
                props
            ...
            {CreateItems(
                "Bowl Special",
                {
                    ...
                    "Beef Teriyaki": [
                        "Grilled beef steak with teriyaki sauce over rice",
                        "L 15.95 | D 18.95"
                    ]
                },
                props
